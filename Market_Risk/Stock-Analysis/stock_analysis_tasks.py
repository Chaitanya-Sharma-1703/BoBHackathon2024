...
class StockAnalysisTasks():
  def research(self, agent, company):
    return Task(description=dedent(f"""
      ...
      """),
      agent=agent,
      expected_output="""return as described in the description"""
    )
  ...
  def financial_analysis(self, agent): 
    return Task(description=dedent(f"""
      ...
      """),
      agent=agent,
      expected_output="""return what is given in the description of task"""
    )
  ...
  def filings_analysis(self, agent):
    return Task(description=dedent(f"""
      ...
      """),
      agent=agent,
      expected_output="""return as described in the description of task"""
    )
  ...
  def recommend(self, agent):
    return Task(description=dedent(f"""
      ...
      """),
      agent=agent,
      expected_output="""return what you get after performing the task define in the description"""
    )
